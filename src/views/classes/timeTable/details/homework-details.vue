<template>
  <div class="preview-details main-view homework-details">
            ...
            <div class="image__preview">
              ...
              >
                ...
                >
                  <!-- TODO -->
                  <div class="audio">
                    <!-- <img :src="item.thumbnailPathId" alt="" /> -->
                    <el-image
                      style="width: 192px; height: 144px"
    ...
    ></audio-dialog-vue>
    <!-- pdf -->
    <el-dialog :visible.sync="dialogPdfVisible">
      <div class="content-box" style="height:470px">
